...
ChiApplicationWindow {
    ...
    // ── Keep Chi toolbar for window controls + drag ─────────
    showMenu: false
    showTitle: false
    toolbarHeight: 38
    controlsStyle: "macOS"
    ...
    // ── Content fills the Chi content area exactly ──────────
    // ChiApplicationWindow provides a content area below its toolbar.
    // We fill it completely — tab bar at top, terminal fills middle,
    // status bar at bottom. All flush to edges.
